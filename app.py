...
def fetch_poster(movie_id):
    url = "https://api.themoviedb.org/3/movie/{}?api_key=66d88270b054702d07b51c8236c8700b&language=en-US".format(id)
...
movies_dict=pickle.load(open('movie-recommender-system\movie_dict','rb'))
